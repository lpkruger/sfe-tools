...
public class Bob {
	...
	int cc_num;
        ...
        Socket sock = null;
	ByteCountOutputStreamSFE bytecount = null;
	...
	MyUtil.WRITE_MODE = MyUtil.MODE_SETUP;
        ...
        try {
            ...
            toAlice = new ObjectOutputStream(
	      bytecount = new ByteCountOutputStreamSFE(sock.getOutputStream()));
	...
	num_of_iterations = aint >> 8 ;
	    ...
	    for (j = 0; j < num_of_circuits; j++) {
               ...
               System.out.println("EncPayload:" + c.cmeasureEncPayload());
               System.out.println("SecPayload:" + c.cmeasureSecPayload());
	...
	System.out.println("phasecnt: " + bytecount.phasecnt[MyUtil.MODE_CIRCUIT]);
        ...
        if (bytecount != null) {
        System.out.println("Wrote " + bytecount.cnt + " bytes");
