...
public class Formatter implements Serializable {
    ...
    public void getInput(Circuit c, boolean is_alice, BufferedReader br) {
    	boolean random_values = true; // System.getProperty("RANDOM_INPUT") != null;
    ...
    // programmatic varient
    public void getInput(Circuit c, boolean is_alice, String[] args) {
        IO io = null;
        String inpline = null;
    ...
    public long[] getOutputVals(Circuit c, boolean is_alice) {
        long bit;
        long value;
	long[] outputs = new long[FMT.size()];
	...
	long[] ret = new long[outputNo];
	System.arraycopy(outputs, 0, ret, 0, outputNo);
	return ret;
    }
