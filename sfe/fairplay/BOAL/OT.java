...
import sfe.util.ByteCountOutputStream;
...
public class OT {
    ...
    public void executeChooserOTs_BOT(Vector v, ObjectOutputStream oos,
	ObjectInputStream ois) {
	BigInteger blind,b;
	int selected;	
    ...
    public void executeSenderOTs_BOT(Vector v, ObjectOutputStream oos,
        ObjectInputStream ois) {
	BigInteger r;
    ...
    public void executeChooserOTs_BOTBatch(Vector v, ObjectOutputStream oos,
        ObjectInputStream ois) {
	BigInteger blind;
    ...
    public void executeSenderOTs_BOTBatch(Vector v, ObjectOutputStream oos,
        ObjectInputStream ois) {	
	BigInteger r,y;
