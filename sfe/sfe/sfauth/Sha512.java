...
public class Sha512 {
	...
	public static byte[] padBuffer(int count)
	{
...
*/
	public static void dump(long a,long b,long c,long d,long e, long f, long g, long h) {
		System.out.printf("%016x %016x %016x %016x %016x %016x %016x %016x\n", a,b,c,d,e,f,g,h);
	}
